 ...
 */
final class Version20201009220111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commune (id INT AUTO_INCREMENT NOT NULL, non VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, code_departement VARCHAR(255) NOT NULL, code_region VARCHAR(255) NOT NULL, codes_postaux LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
